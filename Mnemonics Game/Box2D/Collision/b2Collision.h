...
struct b2WorldManifold
{
	...
	void Initialize(const b2Manifold *manifold, const b2Transform &xfA,
			float32 radiusA, const b2Transform &xfB,
			float32 radiusB);

	b2Vec2 normal; ///< world vector pointing from A to B
	b2Vec2 points[b2_maxManifoldPoints]; ///< world contact point (point of
					     ///< intersection)
	float32
	    separations[b2_maxManifoldPoints]; ///< a negative value indicates
					       ///< overlap, in meters
};
...
bool b2TestOverlap(const b2Shape *shapeA, int32 indexA, const b2Shape *shapeB,
		   int32 indexB, const b2Transform &xfA,
		   const b2Transform &xfB);
