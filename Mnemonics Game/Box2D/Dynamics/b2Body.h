...
struct b2BodyDef
{
	...
	/// Note: if a dynamic body would have zero mass, the mass is set to
	/// one.
	b2BodyType type;
...
{
      public:
	/// Creates a fixture and attach it to this body. Use this function if
	/// you need to set some fixture parameters, like friction. Otherwise
	/// you can create the fixture directly from a shape. If the density is
	...
	/// parameters like friction, restitution, user data, or filtering. If
	/// the density is non-zero, this function automatically updates the
	/// mass of the body.
	...
	/// automatically adjust the mass of the body if the body is dynamic and
	/// the fixture has positive density. All fixtures attached to a body
	/// are implicitly destroyed when the body is destroyed.
	...
	/// fixtures. Note that this changes the center of mass position. Note
	/// that creating or destroying fixtures can also alter the mass. This
	...
	/// the fixtures. This normally does not need to be called unless you
	/// called SetMassData to override the mass and you later want to reset
	/// the mass.
	void ResetMassData();

	/// Get the world coordinates of a point given the local coordinates.
	/// @param localPoint a point on the body measured relative the the
	/// body's origin.
	...
	/// Gets a local point relative to the body's origin given a world
	/// point.
	...
	/// Get the world linear velocity of a world point attached to this
	/// body.
	/// @param a point in world coordinates.
