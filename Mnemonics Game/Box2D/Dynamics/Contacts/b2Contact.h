...
struct b2ContactEdge
{
	...
	b2ContactEdge
	    *next; ///< the next contact edge in the body's contact list
};
...
class b2Contact
{
	...
	/// b2ContactListener::PreSolve. The value persists until you set or
	/// reset.
	...
	/// Set the desired tangent speed for a conveyor belt behavior. In
	/// meters per second.
	...
	static b2ContactRegister s_registers[b2Shape::e_typeCount]
					    [b2Shape::e_typeCount];
...
inline void b2Contact::GetWorldManifold(b2WorldManifold *worldManifold) const
{
	...
	worldManifold->Initialize(&m_manifold, bodyA->GetTransform(),
				  shapeA->m_radius, bodyB->GetTransform(),
				  shapeB->m_radius);
}
