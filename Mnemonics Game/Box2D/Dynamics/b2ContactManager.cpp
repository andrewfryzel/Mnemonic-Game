...
void b2ContactManager::Collide()
{
	...
	while (c)
	{
		...
		if (c->m_flags & b2Contact::e_filterFlag)
		{
			...
			if (m_contactFilter && m_contactFilter->ShouldCollide(
		...
		bool activeA =
		    bodyA->IsAwake() && bodyA->m_type != b2_staticBody;
		bool activeB =
		    bodyB->IsAwake() && bodyB->m_type != b2_staticBody;
...
void b2ContactManager::AddPair(void *proxyUserDataA, void *proxyUserDataB)
{
	...
	// Call the factory.
	b2Contact *c =
	    b2Contact::Create(fixtureA, indexA, fixtureB, indexB, m_allocator);
	if (c == nullptr)
	{
		return;
	}
