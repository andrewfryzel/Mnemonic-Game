...
/// created via b2Body::CreateFixture.
/// @warning you cannot reuse fixtures.
class b2Fixture
{
      public:
	/// Get the type of the child shape. You can use this to down cast to
	/// the concrete shape.
	/// @return the shape type.
	b2Shape::Type GetType() const;

	/// Get the child shape. You can modify the child shape, however you
	/// should not change the number of vertices because this will crash
	/// some collision caching mechanisms. Manipulating the shape may lead
	...
	/// Set the contact filtering data. This will not update contacts until
	/// the next time step when either parent body is active and awake. This
	...
	/// disabled by b2ContactFilter::ShouldCollide.
	void Refilter();

	/// Get the parent body of this fixture. This is nullptr if the fixture
	/// is not attached.
	...
	/// this to store your application specific data.
	...
	/// density and the shape. The rotational inertia is about the shape's
	/// origin. This operation may be expensive.
	void GetMassData(b2MassData *massData) const;

	/// Set the density of this fixture. This will _not_ automatically
	/// adjust the mass of the body. You must call b2Body::ResetMassData to
	...
	/// Set the coefficient of friction. This will _not_ change the friction
	...
	// constructor/destructor because the destructor cannot access the
	// allocator (no destructor arguments allowed by C++).
