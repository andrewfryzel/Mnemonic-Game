...
class b2ContactFilter
{
	...
	/// these two shapes.
	/// @warning for performance reasons this is only called when the AABBs
	/// begin to overlap.
...
class b2ContactListener
{
	...
	/// is useful for inspecting impulses. Note: the contact manifold does
	/// not include time of impact impulses, which can be arbitrarily large
	/// if the sub-step is small. Hence the impulse is provided explicitly
...
class b2RayCastCallback
{
	...
	/// cast proceeds by returning a float: return -1: ignore this fixture
	/// and continue return 0: terminate the ray cast return fraction: clip
